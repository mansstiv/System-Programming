...
<br>
Commands and and running remains the same. Input files can be found in input_dir directory, which is created by a [bash script](diseaseAggregator/create_infiles.sh).
