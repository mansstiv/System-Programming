...
<p>Commands and and running remains the same. Input files can be found in input_dir directory, which is created by a <a src="diseaseAggregator/create_infiles.sh">bash script</a>.</p>
